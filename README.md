...
<p align="center">
  ...
  <a href="./app/CineTheta-v1.0.3.apk"><img src="https://img.shields.io/badge/Latest_Release-v1.0.3-7044FA?style=for-the-badge&logo=android&logoColor=white" alt="Latest Version"></a>
...
| :--- | :--- | :---: | :---: | :---: | :---: |
| 🟢 **v1.0.3** *(Latest)* | Sep 23, 2026 | `8` | `~17.5 MB` | [📥 Download v1.0.3](./app/CineTheta-v1.0.3.apk) | [GitHub CDN](https://github.com/cinetheta/cinetheta.github.io/releases/download/v1.0.3/CineTheta-v1.0.3.apk) |
...
1. **Download APK**: Tap the direct download link for the latest [CineTheta-v1.0.3.apk](./app/CineTheta-v1.0.3.apk).
...
cinetheta/
├── app/
│   ├── CineTheta-v1.0.3.apk   # Current latest stable APK (Build 8)
